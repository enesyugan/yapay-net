...
#    print(model)
   ...
   ## bpe_dict = load_bpe(args.bpe_dict)
    ...
    print("train start...")
    ignore_keys_for_eval = ["decoder_hidden_states","cross_attentions","encoder_hidden_states"]
    trainer.train(args.load_model_path, ignore_keys_for_eval=ignore_keys_for_eval) if args.continue_training else trainer.train(ignore_keys_for_eval=ignore_keys_for_eval)
